...
import HandleChangeRole from "../api/admin/HandleChangeRole";
...
const ListUsersAdmin = ({ dataUsers }: { dataUsers: UserProps[] }) => {
  ...
  const ChangeRoleUser = async (role: string, userId: string) => {
    const result = await HandleChangeRole(role, userId);
    ...
    <div className="" style={{ width: "100%" }}>
            ...
            <div className="modal-content border-0 shadow-lg rounded-4 p-2 bg-white">
              ...
              <div className="modal-body p-3">
                ...
                <div
                  ...
                  onClick={() =>
                    selectedUser && ChangeRoleUser("user", selectedUser.id)
                  }
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    ...
                    <div className="text-muted extra-small">
                      Standard access for individuals.
                    </div>
                  </div>
                  {selectedUser?.role === "user" && (
                ...
                <div
                  ...
                  onClick={() =>
                    selectedUser && ChangeRoleUser("business", selectedUser.id)
                  }
                  style={{ cursor: "pointer", transition: "all 0.2s" }}
                >
                  ...
                  <div className="flex-grow-1">
                    <div className="fw-bold small">Business</div>
                    <div className="text-muted extra-small">
                      Extended tools for partners.
                    </div>
                  </div>
                  {selectedUser?.role === "business" && (
      ...
      {showToast && (
        <div
          ...
          style={{ zIndex: 1060 }}
        >
          <div className="toast show align-items-center text-white bg-dark border-0 p-1 rounded-3 shadow-lg">
            <div className="d-flex align-items-center">
